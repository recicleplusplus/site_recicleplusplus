...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void openURLManager() async {
    const url = 'https://reciclaplusnew.firebaseapp.com';
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      /// Não è possível abrir a URL
        ...
        child: Column(
          children: [
                              ...
                              largura < 600
                                  ? Column(
                                      mainAxisAlignment: MainAxisAlignment
                                          .start, // This will evenly space the buttons
                                      children: [
                                        ElevatedButton(
                                  ...
                                  : Row(
                                      mainAxisAlignment: MainAxisAlignment
                                          .center, // This will evenly space the buttons
                                      children: [
                                        ElevatedButton(
                                          onPressed: openURLColetor,
                                          style: ButtonStyle(
            ...
            Card(
              ...
              child: Container(
                width: largura < 600 ? largura : 1000,
                decoration: BoxDecoration(
